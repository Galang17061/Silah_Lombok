                        ...
                        <div class="card">
                            <div class="card-body">
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-md-10">
                                        <input type="file" class="dropify image" data-default-file="{{ asset("../storage/app/".$data->image) }}" name="image"/>
                                    </div>
                                </div>
                                <div class="mt-4">
            ...
            $.ajax({
                ...
                success:function(data){
                    if (data.status == 'sukses') {
                        if (result.value) {Swal.fire('Updated!','Your file has been Updated.','success')}
                    }else if(data.status == 'gagal'){
                        if (result.value) {Swal.fire('Fail!','your file could not be saved'+$data.problem,'error')}
