                        ...
                        <div class="card">
                            <div class="card-body">
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-md-10">
                                        <input class="form-control" type="text" name="dpd_description" value=""
                                            id="example-text-input">
                                    </div>
                                </div>
                                <div class="form-group row">
                                    ...
                                    <div class="col-md-10">
                                        <input class="form-control" type="text" name="dpd_price_include" value=""
                                            id="example-text-input">
                                    </div>
                                </div>
                                <div class="form-group row">
                                    ...
                                    <div class="col-md-10">
                                        <input class="form-control" type="text" name="dpd_price_exclude" value=""
                                            id="example-text-input">
                                    </div>
                                </div>
                                <div class="form-group row">
                                    ...
                                    <div class="col-md-10">
                                        <input class="form-control" type="text" name="dpd_created_by" value=""
                                            id="example-text-input">
                                    </div>
                                </div>
                                <div class="form-group row">
                                    <label for="example-text-input" class="col-md-2 col-form-label">Updated By</label>
                                    <div class="col-md-10">
                                        <input class="form-control" type="text" name="dpd_updated_by" value=""
                                            id="example-text-input">
                                    </div>
                                </div>
                                <div class="mt-4">
