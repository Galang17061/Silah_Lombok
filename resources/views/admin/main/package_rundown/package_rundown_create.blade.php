                        ...
                        <div class="card">
                            <div class="card-body">
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-md-10">
                                        <input class="form-control" type="text" name="dpr_package" value=""
                                            id="example-text-input">
                                    </div>
                                </div>
                                <div class="form-group row">
                                    <label for="example-text-input" class="col-md-2 col-form-label">Day</label>
                                    <div class="col-md-10">
                                        <input class="form-control" type="text" name="dpr_day" value=""
                                            id="example-text-input">
                                    </div>
                                </div>
                                <div class="mt-4">
  ...
  $('.dropify').dropify();
   ...
   function save(argument) {
        ...
        Swal.fire({
            ...
            $.ajax({
                type: "post",
                url:"{{ route('package_rundown_save') }}",
