                        ...
                        <div class="card">
                            <div class="card-body">
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-md-10">
                                        <input class="form-control" type="text" name="dprd_package" value=""
                                            id="example-text-input">
                                    </div>
                                </div>
                                <div class="form-group row">
                                    <label for="example-text-input" class="col-md-2 col-form-label">Schedule</label>
                                    <div class="col-md-10">
                                        <input class="form-control" type="text" name="dprd_schedule" value=""
                                            id="example-text-input">
                                    </div>
                                </div>
                                <div class="form-group row">
                                    <label for="example-text-input" class="col-md-2 col-form-label">Dt</label>
                                    <div class="col-md-10">
                                        <input class="form-control" type="text" name="dprd_dt" value=""
                                            id="example-text-input">
                                    </div>
                                </div>
                                <div class="mt-4">
  ...
  $('.dropify').dropify();
   ...
   function save(argument) {
        ...
        Swal.fire({
            ...
            $.ajax({
                type: "post",
                url:"{{ route('package_rundown_detail_save') }}",
