                        ...
                        <div class="card">
                            <div class="card-body">
                                <form class="form_save">
                                    <input type="hidden" name="id" value="{{$data->d_package->mcp_id}}">
                                    <div class="form-group row">
                                        <label for="example-text-input" class="col-md-2 col-form-label">Nama</label>
                                        <div class="col-md-10">
                                            <input class="form-control" type="text" name="mcp_title"
                                                value="{{ $data->mcp_title }}" id="example-text-input">
                                        </div>
                                    </div>
                                    <div class="mt-4">
...
<script>
    ...
    function save(argument) {
        ...
        Swal.fire({
            ...
            $.ajax({
                type: "post",
                url: "{{ route('category_package_update') }}",
                ...
                success: function (data) {
                    if (data.status == 'sukses') {
                        if (result.value) {
                            ...
                            // return redirect() - > route('category_package');
                        }
