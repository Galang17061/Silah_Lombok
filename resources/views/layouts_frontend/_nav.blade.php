<nav class="navbar navbar-expand-lg navbar-light bg-transparent custom-sticky" style="z-index: 100000000;width:100%">
    <a class="navbar-brand" href="{{route('index')}}" style="color: aliceblue">Silah Lombok</a>
    ...
    <div class="collapse navbar-collapse" id="navbarSupportedContent">
        ...
        <ul class="navbar-nav" style="position: relative; right: 100px">
            <li class="nav-item active">
                <a class="nav-link" href="{{route('index')}}" style="color: aliceblue">Home<span class="sr-only">(current)</span></a>
            </li>
            ...
            <li class="nav-item">
                <a class="nav-link" href="#" style="color: aliceblue">Blog<span class="sr-only">(current)</span></a>
            </li>
            <li class="nav-item">
                <a class="nav-link" href="#" style="color: aliceblue">Contact<span class="sr-only">(current)</span></a>
            </li>
        </ul>
    </div>
</nav>
